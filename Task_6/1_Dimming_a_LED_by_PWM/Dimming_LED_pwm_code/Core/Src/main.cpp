...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : STICK_CENTER_Pin STICK_RIGHT_Pin STICK_UP_Pin STICK_LEFT_Pin
                           STICK_DOWN_Pin */
  GPIO_InitStruct.Pin = STICK_CENTER_Pin|STICK_RIGHT_Pin|STICK_UP_Pin|STICK_LEFT_Pin
                          |STICK_DOWN_Pin;
