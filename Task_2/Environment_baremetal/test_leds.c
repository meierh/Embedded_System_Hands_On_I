...
#define STM32F030xC
#include "stm32f0xx.h"
//#include "stm32f030xc.h" // (alternative, cf. README)

/*
This is just a very basic program which turns on all LEDs on the ESA extension board
*/
...
int main(void) {
	...
	// Clock-enable the GPIOA and GPIOB peripherals in 'RCC_AHBENR'.
	RCC->AHBENR |= RCC_AHBENR_GPIOAEN | RCC_AHBENR_GPIOBEN;

	// A7 is connected to LED0
	// This pin should be set to push-pull low-speed output.
