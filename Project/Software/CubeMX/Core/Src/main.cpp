...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOB, DFPlayer_On_Off_Pin | Display_Reset_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pins : DFPlayer_On_Off_Pin Display_Reset_Pin */
    GPIO_InitStruct.Pin = DFPlayer_On_Off_Pin | Display_Reset_Pin;
