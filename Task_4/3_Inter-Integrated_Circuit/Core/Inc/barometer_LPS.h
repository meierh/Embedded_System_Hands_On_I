...
#ifndef INC_3_INTER_INTEGRATED_CIRCUIT_BAROMETER_LPS_H
#define INC_3_INTER_INTEGRATED_CIRCUIT_BAROMETER_LPS_H
#include "i2c_sensor.h"

class barometer_LPS : i2c_sensor {
public:
    // register addresses
...
#endif //INC_3_INTER_INTEGRATED_CIRCUIT_BAROMETER_LPS_H
